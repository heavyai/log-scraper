...
test:
	...
	cargo run tests/omnisci_server.INFO -f sqlquery -t sql > target/test/omnisci_server.INFO-sqlquery.sql
	...
	diff tests/gold/omnisci_server.INFO-sqlquery.sql target/test/omnisci_server.INFO-sqlquery.sql
